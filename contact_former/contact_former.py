...
import contact_former.transformer as transformer
from contact_former.posa_models import POSA
from contact_former.models_common import *
...
class ContactFormer(nn.Module):
    def __init__(self, seg_len, encoder_mode, decoder_mode, n_layer=6, n_head=8, f_vert=64, dim_ff=512,
                 d_hid=512, mesh_ds_dir="data/protext/mesh_ds", posa_path=None, **kwargs):
